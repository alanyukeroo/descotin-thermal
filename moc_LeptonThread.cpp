...
static const char qt_meta_stringdata_LeptonThread[] = {
    ...
    "performFFC()\0setA0(int)\0setA1(int)\0"
    "setA2(int)\0"
};
...
void LeptonThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->setA0((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->setA1((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 6: _t->setA2((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
